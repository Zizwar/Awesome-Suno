...
- [HookGenius](https://hookgenius.app) - An AI prompt engine for Suno music creators. Generates complete song lyrics with structure tags, Suno-optimized style prompts (within the 200-character style field), and titles ready to copy-paste into Suno. Built and battle-tested across 10,000+ generations spanning every major genre. Free tier with 5 credits, no card required.
