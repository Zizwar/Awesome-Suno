...
- [samuelgrupolimex-prog/suno-style-recipes](https://github.com/samuelgrupolimex-prog/suno-style-recipes) - 564 documented styles with the style prompt, BPM, weirdness and style influence for each, as a markdown table, CSV, JSON and Parquet. CC0.
